...
const DOMAINS = [
  {
    ...
    cluster: "processing",
    tagline: "Seeing relationships others miss",
    description: "Identifying patterns and connections across different contexts. Working with underlying structures and relationships beyond surface details.",
  ...
  },
  {
    ...
    description: "Building and evaluating chains of reasoning. Breaking complex challenges into manageable steps and spotting gaps in logic.",
    color: BRAND.cerulean,
  },
  {
    id: "speed",
    ...
    cluster: "processing",
    tagline: "Quick, accurate thinking",
    description: "The pace at which information is processed and decisions are made — balancing speed with accuracy under different demands.",
    color: BRAND.cerulean,
  },
  {
    id: "memory",
    code: "MA",
    name: "Memory & Focus",
    fullName: "Memory & Attention",
    cluster: "processing",
    tagline: "Holding and using information",
    description: "Sustaining attention, encoding and retrieving information, and managing competing demands on focus.",
    color: BRAND.indigo,
  },
  {
    id: "executive",
    ...
    cluster: "regulation",
    tagline: "Organising and adapting",
    description: "Planning, self-regulation, and adapting when circumstances change. Holding goals in mind while managing complexity.",
    color: BRAND.teal,
  },
  {
    id: "metacognition",
    ...
    cluster: "regulation",
    tagline: "Knowing how you think",
    description: "Monitoring your own thinking, recognising when strategies aren't working, and adjusting approach accordingly.",
    color: BRAND.teal,
  },
  {
    id: "confidence",
    ...
    cluster: "regulation",
    tagline: "Believing you can figure it out",
    description: "Self-belief and learning mindset. How people respond to uncertainty, difficulty, and sustained cognitive effort.",
    color: BRAND.violet,
  },
  {
    id: "creativity",
    ...
    cluster: "creative",
    tagline: "Generating fresh possibilities",
    description: "Producing novel ideas, seeing alternative approaches, and thinking beyond the obvious when problems are open-ended.",
    color: BRAND.violet,
  },
];
...
const AUDIENCES = {
  schools: {
    ...
    body: "Wadmore gives educators a precise, evidence-based view of how each student thinks — enabling informed differentiation, meaningful support conversations, and confident pathway decisions.",
    points: [
  ...
  families: {
    label: "Families",
    color: BRAND.teal,
    headline: "Understand your child's mind.",
    ...
    points: [
      ...
      "Practical activities matched to how your child thinks",
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 py-20 md:py-28 relative z-10 w-full">
        <div className="max-w-3xl">
          ...
          >
            ...
            />
            Cognitive assessment that sees the whole person
          </div>
          ...
          >
            Wadmore reveals <strong style={{ color: BRAND.slate }}>how people think</strong> — 
            not just what they know. Strength-based cognitive profiles across 
            eight domains, designed for schools, families, and organisations.
          </p>
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Link 
              to="/schools"
              className="inline-flex items-center gap-2 px-8 py-4 rounded-full text-base font-semibold transition-colors hover:bg-white"
              style={{ 
    ...
    >
      ...
      <div className="max-w-4xl mx-auto px-6 md:px-8 text-center relative z-10">
        ...
        <p className="text-lg md:text-xl text-white/70 mb-10 max-w-2xl mx-auto">
          ...
          building a team — Wadmore provides clarity about how minds work.
        </p>
